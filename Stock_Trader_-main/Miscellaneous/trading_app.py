...
def main():
    ...
    st.write("Upload your stock data (CSV format) and select a strategy to simulate trading.")
    ...
    if uploaded_file is not None:
        ...
        # Currency conversion
        country = st.selectbox("Select the index country", options=["India", "USA", "Japan"]) #TBR
